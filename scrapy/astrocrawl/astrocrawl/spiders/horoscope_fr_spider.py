...
class HFRSpider(scrapy.Spider):
    ...
    def parse(self, response):
        item = AstrocrawlItem()
        item["love"] = response.xpath("//*[@id='horo-jour-amour']/div[1]/p[2]/text()").extract()
        item["money"] = response.xpath("//*[@id='horo-jour-travail']/div[2]/div[2]/p/text()").extract()
        item["health"] = response.xpath("//*[@id='horo-jour-bienetre']/div[1]/div[2]/p/text()").extract()
        item["work"] = response.xpath("//*[@id='horo-jour-travail']/div[1]/div[2]/p/text()").extract()
        yield item